    ...
    <div className="mt-24 px-32 flex gap-24 justify-start">
      <div className="min-w-[450px] h-[600px] max-w-[450px]  border-[var(--theme-red)] border-[4px]">
        <Image
          ...
          width={1000}
          height={1000}
          className="min-w-[450px] h-[600px] object-center object-cover translate-x-6 translate-y-6"
        />
      </div>
      <div className="flex flex-col justify-center gap-8">
        ...
        <div className="flex justify-between border-t-[3px] border-t-[var(--theme-red)] pt-8 mt-2">
