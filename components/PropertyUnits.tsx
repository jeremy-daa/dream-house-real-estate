...
const PropertyUnits = () => {
  return (
    <div className="padding">
      <div className="flex flex-col md:gap-10 gap-8  items-center">
        <h2 className="title text-[var(--theme-blue)] font-semibold text-center">
          Our Property Units
        </h2>
        <p className="text-center subtitle text-slate-500 max-w-xl">
          We offer a wide range of property unit options to suit your needs.
          Here are some of our featured property units.
        </p>
